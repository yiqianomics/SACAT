...
# in at least 5% of samples. For the present depth-aware analysis, counts are
# not rarefied. The standard MicrobiomeHD count filters are applied to the full
# 490-sample cohort before the primary comparison is selected. The publication's
# 5% feature-prevalence rule is then evaluated in the CRC-versus-no-lesion
# cohort. The original, pre-filtering library size is carried forward for DASRA.
